      ...
      case $yne in
        ...
        Yes )
          ...
          if command -v alacritty >/dev/null; then
            ...
            echo "# https://draculatheme.com/alacritty\ncolors:\n  primary:\n    background: '#282a36'\n    foreground: '#f8f8f2'\n    bright_foreground: '#ffffff'\n  cursor:\n    text: CellBackground\n    cursor: CellForeground\n  vi_mode_cursor:\n    text: CellBackground\n    cursor: CellForeground\n  search:\n    matches:\n      foreground: '#44475a'\n      background: '#50fa7b'\n    focused_match:\n      foreground: '#44475a'\n      background: '#ffb86c'\n  footer_bar:\n    background: '#282a36'\n    foreground: '#f8f8f2'\n  hints:\n    start:\n      foreground: '#282a36'\n      background: '#f1fa8c'\n    end:\n      foreground: '#f1fa8c'\n      background: '#282a36'\n  line_indicator:\n    foreground: None\n    background: None\n  selection:\n    text: CellForeground\n    background: '#44475a'\n  normal:\n    black: '#21222c'\n    red: '#ff5555'\n    green: '#50fa7b'\n    yellow: '#f1fa8c'\n    blue: '#bd93f9'\n    magenta: '#ff79c6'\n    cyan: '#8be9fd'\n    white: '#f8f8f2'\n  bright:\n    black: '#6272a4'\n    red: '#ff6e6e'\n    green: '#69ff94'\n    yellow: '#ffffa5'\n    blue: '#d6acff'\n    magenta: '#ff92df'\n    cyan: '#a4ffff'\n    white: '#ffffff'" > "$XDG_CONFIG_HOME/alacritty/theme.yml"
            echo "# Colors (Gruvbox light)\ncolors:\n  # Default colors\n  primary:\n    # hard contrast:\n    background: '0xf9f5d7'\n    # normal contrast:\n    # background: '0xfbf1c7'\n    # soft contrast: background = '0xf2e5bc'\n    foreground: '0x3c3836'\n\n  # Normal colors\n  normal:\n    black:   '0xfbf1c7'\n    red:     '0xcc241d'\n    green:   '0x98971a'\n    yellow:  '0xd79921'\n    blue:    '0x458588'\n    magenta: '0xb16286'\n    cyan:    '0x689d6a'\n    white:   '0x7c6f64'\n\n  # Bright colors\n  bright:\n    black:   '0x928374'\n    red:     '0x9d0006'\n    green:   '0x79740e'\n    yellow:  '0xb57614'\n    blue:    '0x076678'\n    magenta: '0x8f3f71'\n    cyan:    '0x427b58'\n    white:   '0x3c3836'" > "$XDG_CONFIG_HOME/alacritty/theme_alt.yml"
            echo '#!/bin/env bash\ntheme=$HOME/.config/alacritty/theme.yml\ntheme_alt=$HOME/.config/alacritty/theme_alt.yml\n[[ -f $theme && -f $theme_alt ]] || return\nif command -v alacritty >/dev/null; then\n  command mv "$theme" "${theme}_temp"\n  command mv "$theme_alt" "$theme"\n  command mv "${theme}_temp" "$theme_alt"\n  if command grep -q "status-style fg=colour254" "$HOME/.config/tmux/tmux.conf" \\n    && grep -q "light" "$HOME/.config/alacritty/theme.yml"; then\n    sed -i 's/\(status-style fg=colour\)254/\1235/g' "$HOME/.config/tmux/tmux.conf"\n  else\n    sed -i 's/\(status-style fg=colour\)235/\1254/g' "$HOME/.config/tmux/tmux.conf"\n  fi\n  command tmux source-file "$HOME/.config/tmux/tmux.conf"\nfi' > "$XDG_CONFIG_HOME/alacritty/theme.sh"
